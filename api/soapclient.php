...
class PomSoapClient extends SoapClient
{
    ...
    protected function handleCookie($forceLogin = false)
    {
        ...
        foreach($headers as $name => $header)
        {
            ...
            foreach($header as $cookie)
            {
                ...
                // Check the cookie name
                if(substr($cookie[0], 0, 5) != 'soap_') continue;
    ...
    /**
     *  Helper function to split the replay header
     *  @param  string
     *  @param  array
     */
    protected function parseHeaders($headers)
    {
        // Use the http_parse_headers function if it exists. This comes form pecl extention http
    ...
    public function __call($methodname, $params)
    {
        ...
        while(1)
        {
            ...
            {
                // If we're not logged login agian
